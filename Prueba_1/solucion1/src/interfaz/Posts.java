...
public class Posts extends javax.swing.JFrame {
    ...
    public Posts(String id, String username) {
        initComponents();
        setLocationRelativeTo(null);
        lblName.setText("Posts de @"+username);
        User.buttonPosts.setEnabled(false);
        Jsonwork.getPublicationsAnsersUser(id);
    }
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        User.buttonPosts.setEnabled(true);
